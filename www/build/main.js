...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FitnessPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(33);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
 ...
 * Ionic pages and navigation.
 */
var FitnessPage = (function () {
    function FitnessPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    FitnessPage.prototype.ionViewDidLoad = function () {
...
var LoginOptionsPage = (function () {
    function LoginOptionsPage(navCtrl, navParams, formBuilder, fireAuth) {
        ...
        this.myForm = this.formBuilder.group({
            myPhone: ['+234', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["f" /* Validators */].required],
        });
    ...
    LoginOptionsPage.prototype.closeDatepicker = function () {
    ...
    LoginOptionsPage.prototype.uploadImage = function () {
        console.log('data');
    };
    LoginOptionsPage.prototype.goToOTPScreen = function (elem) {
    ...
    LoginOptionsPage.prototype.goToLoginOptionsScreen = function () {
        this.loginOptionShown = true;
        this.passwordChangeSuccessful = false;
    };
    LoginOptionsPage.prototype.goToSuccessScreen = function () {
    ...
    LoginOptionsPage.prototype.goToLCIDLogin = function () {
        this.loginwithLCID = true;
        this.passwordChangeSuccessful = false;
    };
    LoginOptionsPage.prototype.goToForgotPasswordScreen = function () {
        this.forgotPasswordScreen = true;
    };
    LoginOptionsPage.prototype.goToPasswordSuccessScreen = function () {
        this.changePasswordScreen = false;
        this.passwordChangeSuccessful = true;
    };
    LoginOptionsPage.prototype.goToInterestPage = function () {
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_4__chooseintereset_chooseintereset__["a" /* ChooseinteresetPage */]);
    };
    LoginOptionsPage.prototype.goToHomeScreen = function () {
        ...
        if (eve.keyCode === 8 || eve.keyCode === 37 || eve.keyCode === 46) {
            ...
            if (ef) {
                ...
                setTimeout(function () {
                    ...
                    if (_this.passwordResetFlow) {
                        _this.changePasswordScreen = true;
                        _this.profileDetails = false;
                    }
                    else {
                        _this.profileDetails = true;
                    }
                    _this.loginOptionShown = false;
                    _this.otpVerificationScreen = false;
                    _this.loginSuccessScreen = false;
                    _this.loginwithLCID = false;
                    _this.forgotPasswordScreen = false;
                    _this.passwordChangeSuccessful = false;
                }, 500);
            }
        }
    };
    //Password show or hide
    LoginOptionsPage.prototype.showHide = function () {
    ...
    __decorate([
        ...
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_ion_datepicker__["a" /* DatePickerDirective */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ion_datepicker__["a" /* DatePickerDirective */]) === "function" && _a || Object)
...
var map = {
	"../pages/chooseintereset/chooseintereset.module": [
		625,
		3
	],
...
var config = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAtUPTwKpfT7ITB5YWqxFOIUpg1G-gfhsI",
        authDomain: "lifecompdev.firebaseapp.com",
        databaseURL: "https://lifecompdev.firebaseio.com",
        projectId: "lifecompdev",
        storageBucket: "lifecompdev.appspot.com",
        messagingSenderId: "816762994785"
    }
};
...
function myCustomAudioProviderFactory() {
    return (window.hasOwnProperty('cordova')) ? new __WEBPACK_IMPORTED_MODULE_17_ionic_audio__["b" /* CordovaMediaProvider */]() : new __WEBPACK_IMPORTED_MODULE_17_ionic_audio__["d" /* WebAudioProvider */]();
}
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__pages_fitness_fitness__["a" /* FitnessPage */],
                __WEBPACK_IMPORTED_MODULE_9__pages_expense_expense__["a" /* ExpensePage */],
                __WEBPACK_IMPORTED_MODULE_10__pages_login_options_login_options__["a" /* LoginOptionsPage */],
                __WEBPACK_IMPORTED_MODULE_11__pages_chooseintereset_chooseintereset__["a" /* ChooseinteresetPage */],
                __WEBPACK_IMPORTED_MODULE_18__components_article_article__["a" /* ArticleComponent */],
                __WEBPACK_IMPORTED_MODULE_19__components_article_mini_scroll_article_mini_scroll__["a" /* ArticleMiniScrollComponent */],
                __WEBPACK_IMPORTED_MODULE_20__components_article_scroll_article_scroll__["a" /* ArticleScrollComponent */],
                __WEBPACK_IMPORTED_MODULE_21__components_card_with_audio_card_with_audio__["a" /* CardWithAudioComponent */],
                __WEBPACK_IMPORTED_MODULE_22__components_card_with_form_card_with_form__["a" /* CardWithFormComponent */],
                __WEBPACK_IMPORTED_MODULE_23__components_card_with_landscape_image_card_with_landscape_image__["a" /* CardWithLandscapeImageComponent */],
                __WEBPACK_IMPORTED_MODULE_24__components_card_with_landscape_image_scroll_card_with_landscape_image_scroll__["a" /* CardWithLandscapeImageScrollComponent */],
                __WEBPACK_IMPORTED_MODULE_25__components_card_with_opinion_poll_card_with_opinion_poll__["a" /* CardWithOpinionPollComponent */],
                __WEBPACK_IMPORTED_MODULE_26__components_card_with_potrait_image_card_with_potrait_image__["a" /* CardWithPotraitImageComponent */],
                __WEBPACK_IMPORTED_MODULE_27__components_card_with_potrait_image_scroll_card_with_potrait_image_scroll__["a" /* CardWithPotraitImageScrollComponent */],
                __WEBPACK_IMPORTED_MODULE_28__components_card_with_quotes_card_with_quotes__["a" /* CardWithQuotesComponent */],
                __WEBPACK_IMPORTED_MODULE_29__components_card_with_testimonial_card_with_testimonial__["a" /* CardWithTestimonialComponent */],
                __WEBPACK_IMPORTED_MODULE_30__components_card_with_video_card_with_video__["a" /* CardWithVideoComponent */],
                __WEBPACK_IMPORTED_MODULE_31__components_category_scroll_category_scroll__["a" /* CategoryScrollComponent */],
                __WEBPACK_IMPORTED_MODULE_32__components_home_dashboard_banner_home_dashboard_banner__["a" /* HomeDashboardBannerComponent */],
                __WEBPACK_IMPORTED_MODULE_33__components_profile_completion_card_profile_completion_card__["a" /* ProfileCompletionCardComponent */],
                __WEBPACK_IMPORTED_MODULE_34__components_social_card_social_card__["a" /* SocialCardComponent */],
                __WEBPACK_IMPORTED_MODULE_35__components_tool_card_tool_card__["a" /* ToolCardComponent */],
                __WEBPACK_IMPORTED_MODULE_36__components_tools_scroll_tools_scroll__["a" /* ToolsScrollComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */],
                __WEBPACK_IMPORTED_MODULE_3_ng4_intl_phone__["a" /* InternationalPhoneModule */],
                __WEBPACK_IMPORTED_MODULE_4_ion_datepicker__["b" /* DatePickerModule */],
                __WEBPACK_IMPORTED_MODULE_17_ionic_audio__["c" /* IonicAudioModule */].forRoot(__WEBPACK_IMPORTED_MODULE_17_ionic_audio__["e" /* defaultAudioProviderFactory */]),
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen) {
        this.rootPage = __WEBPACK_IMPORTED_MODULE_4__pages_login_options_login_options__["a" /* LoginOptionsPage */];
...
var TabsPage = (function () {
    function TabsPage() {
        ...
        this.tab2Root = __WEBPACK_IMPORTED_MODULE_2__fitness_fitness__["a" /* FitnessPage */];
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArticleMiniScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var ArticleMiniScrollComponent = (function () {
    function ArticleMiniScrollComponent() {
    ...
    return ArticleMiniScrollComponent;
}());

//# sourceMappingURL=article-mini-scroll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArticleScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var ArticleScrollComponent = (function () {
    function ArticleScrollComponent() {
    ...
    return ArticleScrollComponent;
}());

//# sourceMappingURL=article-scroll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithAudioComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_audio__ = __webpack_require__(344);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components.
 */
var CardWithAudioComponent = (function () {
    function CardWithAudioComponent(_audioProvider) {
    ...
    CardWithAudioComponent.prototype.ngAfterContentInit = function () {
        // get all tracks managed by AudioProvider so we can control playback via the API
        this.allTracks = this._audioProvider.tracks;
    };
    CardWithAudioComponent.prototype.playSelectedTrack = function () {
        // use AudioProvider to control selected track 
        this._audioProvider.play(this.selectedTrack);
    };
    CardWithAudioComponent.prototype.pauseSelectedTrack = function () {
        // use AudioProvider to control selected track 
        this._audioProvider.pause(this.selectedTrack);
    };
    CardWithAudioComponent.prototype.onTrackFinished = function (track) {
    ...
    return CardWithAudioComponent;
}());

//# sourceMappingURL=card-with-audio.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithFormComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithFormComponent = (function () {
    function CardWithFormComponent() {
    ...
    return CardWithFormComponent;
}());

//# sourceMappingURL=card-with-form.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithLandscapeImageComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithLandscapeImageComponent = (function () {
    function CardWithLandscapeImageComponent() {
    ...
    return CardWithLandscapeImageComponent;
}());

//# sourceMappingURL=card-with-landscape-image.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithLandscapeImageScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithLandscapeImageScrollComponent = (function () {
    function CardWithLandscapeImageScrollComponent() {
    ...
    return CardWithLandscapeImageScrollComponent;
}());

//# sourceMappingURL=card-with-landscape-image-scroll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithOpinionPollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithOpinionPollComponent = (function () {
    function CardWithOpinionPollComponent() {
    ...
    return CardWithOpinionPollComponent;
}());

//# sourceMappingURL=card-with-opinion-poll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithPotraitImageComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithPotraitImageComponent = (function () {
    function CardWithPotraitImageComponent() {
    ...
    return CardWithPotraitImageComponent;
}());

//# sourceMappingURL=card-with-potrait-image.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithPotraitImageScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithPotraitImageScrollComponent = (function () {
    function CardWithPotraitImageScrollComponent() {
    ...
    return CardWithPotraitImageScrollComponent;
}());

//# sourceMappingURL=card-with-potrait-image-scroll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithQuotesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithQuotesComponent = (function () {
    function CardWithQuotesComponent() {
    ...
    return CardWithQuotesComponent;
}());

//# sourceMappingURL=card-with-quotes.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithTestimonialComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithTestimonialComponent = (function () {
    function CardWithTestimonialComponent() {
    ...
    return CardWithTestimonialComponent;
}());

//# sourceMappingURL=card-with-testimonial.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardWithVideoComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var CardWithVideoComponent = (function () {
    function CardWithVideoComponent() {
    ...
    return CardWithVideoComponent;
}());

//# sourceMappingURL=card-with-video.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CategoryScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/**
 * Generated class for the CategoryScrollComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
var CategoryScrollComponent = (function () {
    function CategoryScrollComponent() {
        console.log('Hello CategoryScrollComponent Component');
    }
    ...
    return CategoryScrollComponent;
}());

//# sourceMappingURL=category-scroll.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HomeDashboardBannerComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var HomeDashboardBannerComponent = (function () {
    function HomeDashboardBannerComponent() {
    ...
    return HomeDashboardBannerComponent;
}());

//# sourceMappingURL=home-dashboard-banner.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProfileCompletionCardComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var ProfileCompletionCardComponent = (function () {
    function ProfileCompletionCardComponent() {
    ...
    return ProfileCompletionCardComponent;
}());
 ...
 * Components.
 */
var SocialCardComponent = (function () {
 ...
 * Components.
 */
var ToolCardComponent = (function () {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ToolsScrollComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Components.
 */
var ToolsScrollComponent = (function () {
    function ToolsScrollComponent() {
    ...
    return ToolsScrollComponent;
}());

//# sourceMappingURL=tools-scroll.js.map
